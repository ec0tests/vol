                ...
                <div className={`   text-left Card-experiencias ${this.props.tamanyo}`}>
                    <div className={`${this.props.tamanyo}2`}>
                        ...
                        <span
                            ...
                            <div className="row">
                                <div className="col-8 col-md-8 col-lg-8 d-flex align-items-center pl-3 pt-1">
                                    ...
                                    <div className="col-8 col-md-8 col-lg-8 Tipo d-flex align-items-center pl-1 pr-0 pt-2">
