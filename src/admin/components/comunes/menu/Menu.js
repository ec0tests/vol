                ...
                <div className="scroll-sidebar">
                    <nav className="sidebar-nav">
                        <ul id="sidebarnav">
                            ...
                            <li>
                                <a className="has-arrow" href="#" aria-expanded="false"><i className="mdi mdi-gauge"></i><span className="hide-menu">Dashboard </span></a>
                            ...
                            <li>
                                ...
                                <ul aria-expanded="false" className="collapse">
                                    ...
                                    <li>
                                        <a className="has-arrow" href="#" aria-expanded="false">Inbox</a>
                                        <ul aria-expanded="false" className="collapse">
                            ...
                            <li className="two-column">
                                <a className="has-arrow " href="#" aria-expanded="false"><i className="mdi mdi-book-open-variant"></i><span className="hide-menu">Pages</span></a>
                                <ul aria-expanded="false" className="collapse">
                                    ...
                                    <li><a href="pages-utility-className={} es.html">Helper Classes</a></li>
                            ...
                            <li>
                                <a className="has-arrow " href="#" aria-expanded="false"><i className="mdi mdi-widgets"></i><span className="hide-menu">Extra</span></a>
                                <ul aria-expanded="false" className="collapse">
                                    <li>
                                        <a className="has-arrow " href="#" aria-expanded="false">Widgets</a>
                                        <ul aria-expanded="false" className="collapse">
                                    ...
                                    <li>
                                        <a className="has-arrow " href="#" aria-expanded="false">Maps</a>
                                        <ul aria-expanded="false" className="collapse">
                                    ...
                                    <li>
                                        <a className="has-arrow " href="#" aria-expanded="false">Icons</a>
                                        <ul aria-expanded="false" className="collapse">
                                    ...
                                    <li>
                                        <a className="has-arrow " href="#" aria-expanded="false">Charts</a>
                                        <ul aria-expanded="false" className="collapse">
