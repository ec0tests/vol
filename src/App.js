                        ...
                        <div className="container-fluid">
                            <div className="row p-3">
                                <div className="col-6 text-left">
                                    <img src={logo_b} className="img-fluid" alt=""/>
                                </div>
...
<div className="Bk-3-div">
    <img src={bkg3_2} className="Section3-bkg fVerde" alt=""/>
                ...
                <section id="Section5" className="Section5">
                    <div className="container-fluid">
                        <h2 className="Text-gray text-uppercase mb-3 ">Sube tu foto y gana un vuelo con <span
