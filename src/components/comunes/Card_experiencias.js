...
class Card_experiencias extends React.Component {
    ...
    render() {
        ...
        return (
            <div className={ `col-12 col-sm-6 col-md-3 m-4  text-left Card-experiencias ${this.props.tamanyo}` }>
                <div className={`${this.props.tamanyo}2`}>
                    ...
                    <div className="p-2 ">
                        <span className={ `text-uppercase Pack pl-1 ${this.props.pack.toLowerCase()}`}>pack {this.props.pack} <i className="fas fa-home"></i><i
                        ...
                        <div className="row">
                            <div className="col-8 d-flex align-items-center pl-3 pt-1">
                                <div className="col-3 p-0 ">
                                    <img className=" img-fluid" src={require(`../../images/${this.props.iconos}.png`)}
                                         alt="Card photo cap"/>
