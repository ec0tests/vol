            ...
            <div className="Pack-romantico">
                ...
                <main className="Section2-pack-romantico text-left px-5">
                    <div className="container-fluid px-5">
                        <div className="row p-3 Botones-pack-romantico">
                            <div className="col-6 d-flex pl-0">
                                ...
                                <div className="col-3 p-0">
                                    ...
                                    <div id="card_personas" className={`card Pack_romantico-card Pack_romantico-personas `} style={ hidden_filtro_personas }>
                                        <div className="d-flex flex-column p-4 justify-content-start pt-4">
                                            <div className="col-12 d-flex pl-0 pr-0">
                                                ...
                                                <div className="col-6 pr-0 d-flex align-items-center justify-content-around">
                                                    <div onClick={this.rest_adultos.bind(this)} className="Pack_romantico-boton-menos">-</div>
                                                    <span>{this.state.contador_adultos}+</span>
                                                    <div onClick={this.sum_adultos.bind(this)} className="Pack_romantico-boton-mas">+</div>
                                                </div>

                                            </div>
                                            <div className="col-12 d-flex pl-0 pr-0 pt-3">
                                                <div className="col-6 pl-0 d-flex align-items-center">
                                                    <span>Niños <br/> <span className="Pack_romantico-gray">hasta 12 años</span></span>

                                                </div>
                                                <div className="col-6 pr-0 d-flex align-items-center justify-content-around">
                                                    <div onClick={this.rest_ninyos.bind(this)} className="Pack_romantico-boton-menos">-</div>
                                                    <span>{this.state.contador_ninyos}+</span>
                                                    <div onClick={this.sum_ninyos.bind(this)} className="Pack_romantico-boton-mas">+</div>
                                ...
                                <div className="col-3 p-0">
                                    ...
                                    <div id="card_tipovuelo" className={`card Pack_romantico-card Pack_romantico-tipovuelo`} style={ hidden_filtro_tipo }>
                                ...
                                <div className="col-3 p-0">
                                    <button className="Btn-gris-sinfondo Btn-romantico">
                                        Pack Romantico
                                    </button>
                                </div>
                            </div>
